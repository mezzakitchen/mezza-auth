...
export const DEFAULT_CODE_POLICY: CodePolicy = { ttlMinutes: 10, maxLive: 3, maxAttemptsPerEmail: 8, digits: 6 };
export const DEFAULT_RATE_LIMITS: RateLimits = { windowMinutes: 15, requestPerIp: 30, requestPerEmail: 3, requestPerEmailAllApps: 12, verifyPerIp: 60 };
export const DEFAULT_SESSION_POLICY: SessionPolicy = { days: 30, deviceDays: 180, idleDays: 14, touchEveryMinutes: 60 };

export type AuthEventType =
  | "code_requested" | "code_refused" | "code_sent" | "code_send_failed"
  | "verify_ok" | "verify_failed" | "verify_locked"
  | "logout" | "session_revoked" | "sso_issued" | "sso_redeemed" | "sso_rejected";
